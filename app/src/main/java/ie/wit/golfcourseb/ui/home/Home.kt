...
import ie.wit.golfcourseb.databinding.HomeBinding
import ie.wit.golfcourseb.databinding.NavHeaderBinding
...
//            when(destination.id) {
//                R.id.playedFragment -> {
//                    val argument = NavArgument.Builder().setDefaultValue(totalCoursed).build()
//                    destination.addArgument("totalCoursed", argument)
//
//                }
//            }
//        }
