package ie.wit.golfcourseb.ui.auth
...
import ie.wit.golfcourseb.databinding.LoginBinding
import ie.wit.golfcourseb.ui.home.Home
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                when(result.resultCode){
                    RESULT_OK -> {
                        ...
                        Timber.i("GolfcourseB Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
